...
/*   Updated: 2020/08/27 10:48:42 by lvirgini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
t_triangle	create_triange(t_vec3 pos1, t_vec3 pos2, t_vec3 pos3, t_color col);
t_square	create_square(t_vec3 pos, t_vec3 orient, double hight, t_color col);
t_cyl		create_cylindre(t_vec3 pos, t_vec3 orient, double hight,
...
/*
t_square	malloc_square(t_vec3 pos, t_vec3 orient, double hight, t_color col);
t_cyl		malloc_cylindre(t_vec3 pos, t_vec3 orient, double hight,
					double diameter, t_color col);*/
